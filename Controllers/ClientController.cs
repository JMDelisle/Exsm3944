...
namespace Exsm3945_Assignment.Controllers
{
    public class ClientController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Dob,Address")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Dob,Address")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
